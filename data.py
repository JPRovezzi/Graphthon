...
time = [
    ...
    #60ºC #2
    np.array([0, 0, 15, 30, 45, 60, 90, 120, 180, 240, 300, 360, 420, 430]),
    #60ºC #Tolueno
...
time_error = [
    #80ºC
    np.array([-100, 2, 3, 1, 2, 0, 4, 2, 0, 0, 0, 3, 0]),
    #70ºC
    np.array([-100, 2, 3,-1, 0, 0, 1, 0, 0, 0, 4, 0, 0]),
    #60ºC #1
    np.array([-100, 2, 0, 1, 2, 1, 0, 2, 0, 2,-1]),
    #60ºC #2
    np.array([-100, 2, 2, 3, 0, 0, 2, 1, 4, 0, 2, 2, 1, 0]),
    #60ºC #Tolueno
    np.array([-100, 3, 1, 0, 1, 3, 0, 1, 0, 0, 2, 7, 1, 0]),
    ]
...
temperature=[
    ...
    # 60ºC #2
    np.array([58,59,60,60,60,60,60,60,60,60,60,60,60,60]),
    # 60ºC #Tolueno
